...
{{--                @endif--}}
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('admin.permen.updateDetailPermen', [$permenID->id, $msKegiatanId->id])}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5" name="name" id="name">{{$msKegiatanId->name}}</textarea>
                    </div>
                        <div class="form-group">
                            <label class="text"><b>AK</b></label>
                            <input type="number" name="ak" class="form-control" placeholder="AK" value="{{$msKegiatanId->ak}}">
                        </div>
                        <div class="form-group">
                            <label class="text"><b>Satuan</b></label>
                            <input type="text" name="satuan" class="form-control" placeholder="Satuan"  value="{{$msKegiatanId->satuan}}">
                        </div>
