...
$document_physical = isset($document_physical) ? $document_physical : [];
...
<div id="show_detail{{ $id }}" class="show_detail">
    ...
    $list_document_physical = isset($document_physical[$key]) ? $document_physical[$key] : [];
    ?>
    ...
    <div id="dokument_fisik" class="dokument_fisik">
        @if(count($list_document_physical) > 0)
            @foreach($list_document_physical as $key2 => $list2)
                <?php
                $name = isset($list2['name']) ? $list2['name'] : null;
                $location = isset($list2['location']) ? $list2['location'] : null;
                ?>
