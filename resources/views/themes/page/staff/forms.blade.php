...
@extends(is_previous_route_name('admin.profile') == false ? env('ADMIN_TEMPLATE').'._base.layout' : env('ADMIN_TEMPLATE').'._base.profile')
        ...
        <div class="container-fluid">
            ...
            <div class="card {!! $printCard !!}">
                ...
                <div class="card-footer">
                    ...
                    @endif
                    <a href="@if(is_previous_route_name('admin.profile') == false)<?php echo route('admin.' . $thisRoute . '.index') ?>@elseif(is_previous_route_name('admin.profile') == true) <?php echo route('admin.profile') ?> @endif" class="mb-2 mr-2 btn btn-warning"
